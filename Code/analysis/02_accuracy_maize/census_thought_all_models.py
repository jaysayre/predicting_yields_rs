...
(AEF-derived). The Agg-NN (Census-trained) panel was DROPPED from the table
on 2026-08-28 (user request); its headline numbers are cited in prose as
(not shown) and can be regenerated by re-adding
