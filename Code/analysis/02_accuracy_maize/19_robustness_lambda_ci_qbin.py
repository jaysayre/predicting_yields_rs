...
Writes submission_stats.json to Maize_prediction/output/.
Run:  ~/miniforge3/envs/geo_env/bin/python 19_robustness_lambda_ci_qbin.py
"""
...
hist =  pd.read_parquet(os.path.join(P, "adc_aef_hist_bins_gb_preds.parquet"))
...
LAM_ENS, LAM_HIST =  0.72, 0.72   # deployed public point estimate
d =  ev.copy()
...
for name, col in [("fixed", "pred"), ("qbin", "pred_qbin")]:
    # deployed lambda = 0.72 for both variants (public point estimate, Sec 3.6;
