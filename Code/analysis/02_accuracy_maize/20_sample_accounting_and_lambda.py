...
Run:  ~/miniforge3/envs/geo_env/bin/python 20_sample_accounting_and_lambda.py
...
# AEF Hist (bins-only) muni 5-fold CV preds (fully out-of-sample all munis)
kf =  pd.read_parquet(os.path.join(P, "mun_aef_hist_bins_gb_kfold_preds.parquet"))
