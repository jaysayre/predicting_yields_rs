...
# below is produced by stages 01-03 (and train/04 for the municipality
# validation table) into plots/ or tables/ and copied here. The only paper
# table not generated by code is datasets_summary.tex (hand-written data
# summary, kept in Overleaf).
...
copy_to_overleaf:
	...
	# 2026-08-16: sourced from TABLES_DIR, not PLOTS_DIR. 4_gb_aef_hist_ensemble_other_crops.py
	...
	cp "$(PLOTS_DIR)/fig_pipeline_diagram.pdf"            "$(FIG_DIR)/"
	...
	cp "$(PLOTS_DIR)/maize_monthly_harvesting.pdf"        "$(FIG_DIR)/"
