"""
1_prepare_adc_geometries.py — Convert ADC polygons into EE-ready geometry CSVs.
...
Usage:
  python 1_prepare_adc_geometries.py
...
# Simplify + buffer(0) for GEE compatibility (same as 1_ee_alpha_earth_download.py)
