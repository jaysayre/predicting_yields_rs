#!/usr/bin/env bash
# pull_cropland_csvs.sh — download completed ADC cropland-feature CSV exports
# (ls_cropland_features.py; desc `cropfeat<MTAG>_adc_*`) from Google Drive.
#
...
#
# Usage:
#   TAG=crop_aefn2 ./pull_cropland_csvs.sh              # pull the aefn2 run
#   TAG=crop_aefn2 PROJECTS="yield-predict ..." ./pull_cropland_csvs.sh
set -euo pipefail
