"""
ls_cropland_features.py — AEF-mirroring NDVI features on cropland-masked pixels.
...
Usage:
  ~/miniforge3/envs/geo_env/bin/python ls_cropland_features.py --level adc \
...
def build_cmask(batch_geom):
    """ONE cropland mask per batch (mirrors gb/ee_alpha_earth_binned_hist.py)."""
    if args.no_mask:
        return None
