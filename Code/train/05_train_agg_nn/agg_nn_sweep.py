...
Reuses the data-loading, model, and training code from agg_constrained_nn.py.
...
Usage:
  ...
  python3 agg_nn_sweep.py --epochs 300
...
### ------------------------------------------------------------------ ###
### Model Definition (from agg_constrained_nn.py)
### ------------------------------------------------------------------ ###
...
### ------------------------------------------------------------------ ###
### Evaluation metrics (from agg_constrained_nn.py)
### ------------------------------------------------------------------ ###
...
### ------------------------------------------------------------------ ###
### Training helpers (from agg_constrained_nn.py)
### ------------------------------------------------------------------ ###
...
def main():
    ...
    ### ---------------------------------------------------------------- ###
    ### Load data (same as agg_constrained_nn.py)
    ### ---------------------------------------------------------------- ###
