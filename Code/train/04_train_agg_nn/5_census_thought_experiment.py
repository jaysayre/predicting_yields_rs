"""
5_census_thought_experiment.py
============================
Thought experiment: What if the Agg-NN was trained on INEGI census municipality
yields instead of DGSIAP? The census is likely more accurate than DGSIAP, so
...
Usage:
  ...
  python3 5_census_thought_experiment.py --epochs 300
...
### ------------------------------------------------------------------ ###
### Model Definition (from 2_agg_nn_sweep.py)
### ------------------------------------------------------------------ ###
...
def main():
    ...
    ### ---------------------------------------------------------------- ###
    ### Train/val split (80/20 by municipality, same seed as DGSIAP model)
    ### ---------------------------------------------------------------- ###
    ...
    ### ================================================================ ###
    ### Evaluate: Census-trained vs DGSIAP-trained vs RF baseline
    ### ================================================================ ###

    print("\n" + "=" * 70)
    print("  Results: Census-Trained vs DGSIAP-Trained (ADC-level vs INEGI 2022)")
    print("=" * 70)
    ...
    # Load DGSIAP-trained predictions for comparison
    ...
    print(f"\n  DGSIAP-trained Agg-NN (from production CSV):")
