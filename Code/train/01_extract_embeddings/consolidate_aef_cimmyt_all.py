...
Usage:
  python3 consolidate_aef_cimmyt_all.py --type mean --csv_dir /path/to/csvs
  python3 consolidate_aef_cimmyt_all.py --type hist --csv_dir /path/to/csvs
  python3 consolidate_aef_cimmyt_all.py --type binned_hist --csv_dir /path/to/csvs
