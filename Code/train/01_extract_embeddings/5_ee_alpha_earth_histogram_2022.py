"""
5_ee_alpha_earth_histogram_2022.py
================================
...
The all-years script (4_ee_alpha_earth_histogram_allyears.py) extracted
...
Usage:
  ...
  python3 5_ee_alpha_earth_histogram_2022.py
  python3 5_ee_alpha_earth_histogram_2022.py --skip_mun          # ADCs only
  python3 5_ee_alpha_earth_histogram_2022.py --start_state 15    # resume from state 15
