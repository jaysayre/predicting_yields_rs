"""
ee_alpha_earth_cimmyt.py — Extract AEF satellite embeddings for CIMMYT plots.
...
Usage:
  python ee_alpha_earth_cimmyt.py
  python ee_alpha_earth_cimmyt.py --start_state 14 --start_year 2019
