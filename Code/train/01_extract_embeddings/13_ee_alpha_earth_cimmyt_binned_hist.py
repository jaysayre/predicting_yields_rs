"""
13_ee_alpha_earth_cimmyt_binned_hist.py
=====================================
...
Uses the same buffered CIMMYT plot geometries as 11_ee_alpha_earth_cimmyt.py.

Usage:
  conda activate ML_env
  python3 13_ee_alpha_earth_cimmyt_binned_hist.py
  python3 13_ee_alpha_earth_cimmyt_binned_hist.py --start_state 14 --start_year 2019
...
def main():
    ...
    print(f"  python3 14_consolidate_aef_cimmyt_all.py --type binned_hist")
