"""
12_ee_alpha_earth_cimmyt_hist.py
=============================
...
Usage:
  ...
  python3 12_ee_alpha_earth_cimmyt_hist.py
  python3 12_ee_alpha_earth_cimmyt_hist.py --start_state 14 --start_year 2019
...
def main():
    ...
    print(f"  python3 14_consolidate_aef_cimmyt_all.py --type hist")
