"""
6_ee_alpha_earth_binned_hist.py
=============================
...
Usage:
  ...
  python3 6_ee_alpha_earth_binned_hist.py
  python3 6_ee_alpha_earth_binned_hist.py --skip_mun
  python3 6_ee_alpha_earth_binned_hist.py --start_state 15
  python3 6_ee_alpha_earth_binned_hist.py --years 2022
