...
East-Africa extension of the AEF Hist Ensemble (w=0.4 bins + 0.6 percentile,
...
N_PIX, K_SAMP, W_BIN, SEED = 2, 5, 0.4, 42
...
L += [r"\bottomrule", r"\end{tabular}",
      ...
      r"level using HarvestStat Africa yields (2017--2024) and AEF Hist Ensemble ($w=0.4$ bins "
