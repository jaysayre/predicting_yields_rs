...
*** Need to start drafting here
*** CA07 ADC
merge m:1 id_ca22_up using "`loc_cln_ca07'", keep(3) nogen keepusing(id_ca22_up cve_ent muncode adc ageb cve_geo1 cve_ageb1)

*** Need to finish drafting here
