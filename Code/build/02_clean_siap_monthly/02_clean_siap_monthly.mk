...
.PHONY: clean_siap
clean_siap: $(SIAP_OUT)/mnthly_siap.dta $(PLOTS_DIR)/maize_monthly_harvesting.pdf

$(SIAP_OUT)/mnthly_siap.dta: $(TASK_DIR)/1_CleanSIAPMonthlydata.ipynb
	cd $(DATA_DIR) && $(MPC_ENV) $(NB_EXEC) $<

# Monthly planting/harvest calendar figure (paper appendix; pgf/Times like every
# other figure). Rebuilt from the cleaned monthly panel.
$(PLOTS_DIR)/maize_monthly_harvesting.pdf $(PLOTS_DIR)/maize_monthly_harvesting.png &: $(TASK_DIR)/2_plot_maize_monthly_harvesting.py $(SIAP_OUT)/mnthly_siap.dta
