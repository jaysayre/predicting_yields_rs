"""
plot_maize_monthly_harvesting.py — national maize planting/harvesting seasonality.
...
Run: ~/miniforge3/envs/geo_env/bin/python plot_maize_monthly_harvesting.py
